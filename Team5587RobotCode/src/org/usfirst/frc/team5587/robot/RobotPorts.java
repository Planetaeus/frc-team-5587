...
public class RobotPorts 
{
	...
	public static final int RIGHT_MOTOR1 = 0; 
	public static final int RIGHT_MOTOR2 = 1;
	...
	public static final int LIFT_MOTOR1 = 9;
	...
	public static final int JOYSTICK_SECOND = 1;
	
	//Button for slowing
	public static final int SLOW_BUTTON = 1;
	//Button for unslowing
	public static final int UNSLOW_BUTTON = 2;
	//Button for lifting
	public static final int LIFT_BUTTON = 5;
	//Button for lowering
	public static final int LOWER_BUTTON = 6;
}
